...
function create_sudo_customer($api_key,$base_url,$user,$request_data){
    $curl = curl_init();
    ...
    CURLOPT_POSTFIELDS => json_encode([
        ...
        'phoneNumber'   => $request_data['phone_number'] ?? $user->full_mobile,
        "individual" => [
            'identity' => [
                'type' => $request_data['identity_type'],
                'number' => $request_data['identity_number']
            ],
