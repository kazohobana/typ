...
class SupportTicketController extends Controller
{
    ...
    public function index()
    {
        ...
        $support_tickets = UserSupportTicket::authTicketsAgent()->orderByDesc("id")->paginate(10);
        return view('agent.sections.support-ticket.index', compact('page_title','support_tickets'));
    }
    ...
    public function create()
    {
        ...
        return view('agent.sections.support-ticket.create', compact('page_title'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated['agent_id']      = userGuard()['user']->id;
        $validated['status']        = 0;
        ...
        return redirect()->route('agent.support.ticket.index')->with(['success' => [__('Support ticket created successfully!')]]);
    ...
    public function conversation($encrypt_id)
    {
        ...
        $page_title = "";
        return view('agent.sections.support-ticket.conversation', compact('page_title','support_ticket'));
    }
